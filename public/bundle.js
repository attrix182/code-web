(function (exports) {
    ...
    ***************************************************************************** */
    ...
    exports.MainCodeweb = class MainCodeweb extends s {
        constructor() {
            super(...arguments);
            this.html = '';
            this.css = '';
    ...
    exports.MainCodeweb.styles = r$2 `
    .editor {
      padding-top: 1%;
      padding-bottom: 1%;
      display: flex;
  ...
  `;
    __decorate([
        e({ type: String })
    ], exports.MainCodeweb.prototype, "html", void 0);
    __decorate([
        e({ type: String })
    ], exports.MainCodeweb.prototype, "css", void 0);
    __decorate([
        e({ type: String })
    ], exports.MainCodeweb.prototype, "js", void 0);
    exports.MainCodeweb = __decorate([
        n('main-codeweb')
    ], exports.MainCodeweb);

    let ElemIframe = class ElemIframe extends s {
        constructor() {
            super(...arguments);
            this.html = '';
            this.css = '';
...
`;
    __decorate([
        e({ type: String })
    ], ElemIframe.prototype, "html", void 0);
    __decorate([
        e({ type: String })
    ], ElemIframe.prototype, "css", void 0);
    __decorate([
        e({ type: String })
    ], ElemIframe.prototype, "js", void 0);
    ElemIframe = __decorate([
        n('elem-iframe')
    ], ElemIframe);
